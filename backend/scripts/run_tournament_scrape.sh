#!/bin/bash
# Weekly tournament scrape: pulls new Regulation M-B results from
# limitlessvgc.com and loads any new ones into the local database.
# Safe to rerun any time - load_limitless_tournaments.py skips tournaments
# it's already loaded (matched by limitlessvgc.com's own tournament id).
#
